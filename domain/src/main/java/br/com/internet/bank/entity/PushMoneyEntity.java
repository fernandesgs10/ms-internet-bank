...
@Getter
@Entity
@Table(name = "tb_push_money")
public class PushMoneyEntity extends CreateUpdateEntity implements Serializable {

    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Column(name = "co_seq_push", unique = true, nullable = false)
    private Long coSeqSaque;
    ...
    @ManyToOne(fetch = FetchType.LAZY)
    @JoinColumn(name = "co_seq_transaction")
    @JsonBackReference
    @ToString.Exclude
